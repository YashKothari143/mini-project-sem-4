...
<div class="container">
    ...
    <div class="tools-bar" style="background-color: #c8e6c9;">
        ...
        <div class="action-icons">
            ...
            <button onclick="toggleAccountMenu()">👤</button>

            <div id="accountMenu" class="account-menu">
                <p id="accountName">Hello</p>
    ...
    <div class="products">
        ...
        <?php if($category == "vegetable"){ ?>
           <div name="vegetable" class="product vegetable" id="1">
            ...
            <h3>Tomato</h3>
            <p class="price">
	     Price: ₹ <span class="price-value">30</span> / kg
            </p>
        <!-- Add to cart -->
        ...
        <div class="product vegetable" id="2">
            ...
            <h3>Potato</h3>
            <p class="price">Price: ₹ <span class="price-value">30</span> / kg</p>
        ...
        <div class="product fruit" id="3">
            ...
            <h3>Apple</h3>
            <p class="price">Price: ₹ <span class="price-value">80</span> / kg</p>
        ...
        <div class="product fruit"id="4">
            ...
            <h3>Banana</h3>
            <p class="price">Price: ₹ <span class="price-value">60</span> /dozen</p>
       ...
       <div class="product dairy"id="5">
            ...
            <h3>Milk</h3>
            <p class="price">Price: ₹ <span class="price-value">58</span> /litre</p>
        ...
        <div class="product dairy"id="6">
            ...
            <h3>Curd</h3>
            <p class="price">Price: ₹ <span class="price-value">160</span> / kg</p>
